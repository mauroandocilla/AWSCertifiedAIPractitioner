...
const ITEMS = [
  ...
  { key: 'mapa', label: 'Mapa conceptual', to: '/mapa-conceptual' },
  { key: 'recorrido', label: 'Recorrido', to: '/recorrido' },
  { key: 'experiencia', label: 'Mapa de experiencia', to: '/mapa-de-experiencia' },
